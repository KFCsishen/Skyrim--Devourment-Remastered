...
If ((AkTarget.GetActorBase().GetSex() == 1) && (MaleEnabled.GetValue() == 1)) || ((AkTarget.GetActorBase().GetSex() == 0) && (FemaleEnabled.GetValue() == 1))
	dispel()
	MyScript.Debugger("Disabled by "+AkTarget.GetDisplayName()+"'s Gender.", "PredEndoScript")
ElseIf ((AkCaster.GetActorBase().GetSex() == 1) && (MaleEnabled.GetValue() == 1)) || ((AkCaster.GetActorBase().GetSex() == 0) && (FemaleEnabled.GetValue() == 1))
	dispel()
	MyScript.Debugger("Disabled by "+AkCaster.GetDisplayName()+"'s Gender.", "PredEndoScript")
else
